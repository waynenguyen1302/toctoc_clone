            ...
            <div className='lg:absolute relative bottom-0 left-0 pb-6 px-2 md:px-10'>
                <form className='flex gap-4' onSubmit={addComment}>
                    <input
                        ...
                        className='bg-primary px-6 py-4 text-md font-md border-2 w-[250px] md:w-[350px] lg:w[400px] border-gray-100 focus:outline-none focus:border-2 focus:border-gray-200 flex-1 rounded-lg'
                    />
