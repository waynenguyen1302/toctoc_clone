        ...
        <div className='bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center p-14 pt-6 w-[60%]'>
            <div>
                ...
                <div className='border-dashed rounded-xl border-4 border-gray-200 flex flex-col justify-center items-center outline-none mt-10 w-[260px] h-[460px] cursor-pointer hover:border-red-300 hover:bg-gray-100'>
                            ...
                            {videoAsset ? (
                                <div>
                                    <video
                                        ...
                                        loop
                                        controls
                                        className='roundedxl h-[450px] mt-16 bg-black'
                                    >                                        
                                    </video>
                                </div>
                            ) : (
                    ...
                    {wrongFileType && (
                        <p className='text-center text-xl text-red-400 font-semibold mt-4 w-[250px]'>Please select a correct video type</p>
                    )}
                </div>
            </div>
