...
const Profile = ({data}: IProps) => {
    ...
    return (
        <div className="w-full">
            <div className="flex flex-col gap-6 md:gap-10 mb-4 bg-white w-full">
                <div className='flex gap-3 hover:bg-primary p-2 cursor-pointer font-semibold rounded'>
                    ...
                    <div className='flex flex-col justify-center'>
                        <p className='md:text-xl tracking-wider flex gap-1 items-center text-md font-bold text-primary lowercase'>
                ...
                {/* Posted video and Liked video tabs */}
                <div>   
                   <div className="flex gap-10 mb-10 mt-10 border-b-2 border-gray-200 bg-white w-full">
                    ...
                    <div className="flex gap-6 flex-wrap md:justify-start">
                        {videoList.length > 0 ? (
                            ...
                            <NoResults text={`No ${showUserVideos ? 'Posted ' : 'Liked '}Videos Yet`} />
                        )}
                    </div>
                </div>
            </div>
